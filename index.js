...
let list = [
    ...
    ["M7.png", "", 0.01,0.64],
    ["M8.png", "", 0.69,0.64],
    ["M9.png", "Люблю животных,<br>своих учеников<br>       вяжу", 0.35,-0.04],
...
function RecursiveCard(){
    ...
    const HeartEl = "" +
        ...
        `        <img class=\"img\"  src=\"imgs/${list[c][0]}\">\n` +
        "    </div>\n" +
    ...
    const Button = "<button type=\"button\" onclick='ToEnding()' class=\"btn btn-outline-danger btn-lg\" style=\"top: 90%; left: 90%; position: absolute \">\n" +
